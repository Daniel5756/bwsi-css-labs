...
def test_addition():
    ...
    assert simple_calculator("add", -4, -1) == -5          # Test for double negation
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", 4, -5) == 9    # Test for p-n
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", -5, -5) == 25    # Test for n*n=p
